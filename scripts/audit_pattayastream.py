...
ASSETS = [
    '/assets/css/pv-core.css?v=14',
    '/assets/css/pv-sub.css?v=10',
    '/assets/css/pv-home.css?v=8',
    '/assets/js/pv-live.js?v=33',
...
def audit_live_pages() -> None:
    ...
    for path, label in PAGES:
        ...
        checks = [
            ...
            ('GA4', r'G-WSGWG7999E'),
            ('pv-core.css v14', r'pv-core\.css\?v=14'),
        ...
        if path == '/':
            ...
            checks.extend([
                ...
                ('homepage async pv-core', r'pv-core\.css\?v=14" media="print" onload'),
        ...
        if path == '/support/':
            checks.extend([
                ...
                ('async pv-sub.css', r'pv-sub\.css\?v=10" media="print" onload'),
            ])
